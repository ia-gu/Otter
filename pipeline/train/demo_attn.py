...
# @torch.no_grad()
def train_one_epoch(args, model, epoch, mimicit_loaders, tokenizer, optimizer, device_id, accelerator):
...
def parse_args():
    ...
    parser.add_argument("--past_subset_ration", type=float, default=1.0)
    ...
    parser.add_argument("--backward_timing", choices=["separate", "together"], default="separate")
    ...
    parser.add_argument("--save_weight_epoch", default=5)
